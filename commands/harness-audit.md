...
The script audits the current working directory by default and auto-detects whether the target is the flacoAi repo itself or a consumer project using flacoAi.
...
5. Suggested flacoAi skills to apply next
