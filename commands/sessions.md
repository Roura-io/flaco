---
name: sessions
description: Manage flacoAi session history, aliases, and session metadata.
---

# Sessions Command

Manage flacoAi session history - list, load, alias, and edit sessions stored in `~/.claude/session-data/` with legacy reads from `~/.claude/sessions/`.
