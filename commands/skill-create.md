...
Analyze your repository's git history to extract coding patterns and generate SKILL.md files that teach flacoAi your team's practices.
...
3. **Generates SKILL.md** - Creates valid flacoAi skill files
...
*Part of [Everything flacoAi](https://github.com/affaan-m/flacoAi)*
