...
- Multi-model collaboration: Codex (backend) + Gemini (frontend) + flacoAi (orchestration)
...
- **flacoAi (self)** – Orchestration, planning, execution, delivery
...
**flacoAi Synthesis**: Adopt Codex backend plan + Gemini frontend plan, save to `.claude/plan/task-name.md` after user approval.
...
2. External models have **zero filesystem write access**, all modifications by flacoAi
