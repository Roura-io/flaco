...
- End of a work session before closing flacoAi
...
Create the canonical sessions folder in the user's flacoAi home directory:
...
- The file is meant to be read by flacoAi at the start of the next session via `/resume-session`
