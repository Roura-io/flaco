...
Multi-model collaborative execution - Get prototype from plan → flacoAi refactors and implements → Multi-model audit and delivery.
...
- **Code Sovereignty**: External models have **zero filesystem write access**, all modifications by flacoAi
...
**If ace-tool MCP is NOT available**, use flacoAi built-in tools as fallback:
...
**flacoAi as Code Sovereign executes the following steps**:
...
1. **Code Sovereignty** – All file modifications by flacoAi, external models have zero write access
