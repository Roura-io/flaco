...
Tool call shape:
  save_to_unas(
    ...
    category: one of [shortcuts, research, scaffolds, notes, drafts, ideas, other],
...
Before calling save_to_unas, write the content as a markdown document with
these sections:
...
Then call save_to_unas with:
  - category: "ideas"
  - filename: "<slugified-idea-name>.md" (e.g. "recipe-app.md")
  - content: the full markdown document you just wrote
...
Picked categories land under <mount>/<folder>/flaco/<category>/<filename>
